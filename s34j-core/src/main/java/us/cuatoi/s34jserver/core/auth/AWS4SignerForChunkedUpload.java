...
public class AWS4SignerForChunkedUpload extends AWS4SignerBase {
    ...
    public String generateChunkSignature(byte[] dataToChunk) {
        return generateChunkSignature(dataToChunk, "");
    }

    public String generateChunkSignature(byte[] dataToChunk, String nonsigExtension) {
